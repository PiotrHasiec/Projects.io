    ...
    return (
        <div id="SearchCardUser">
          <div className="input-group mb-3">
            ...
            <div className="input-group-append">
              <button className="btn btn-outline-dark" aria-label="Left Align" type="button" name="direction" value="name" onClick={e => onChange(e)}><i className="fa fa-angle-down angle-up"></i></button>
              <button className="btn btn-outline-dark" aria-label="Left Align" type="button" name="direction" value="-name" onClick={e => onChange(e)}><i className="fa fa-angle-up"></i></button>
            </div>
          </div>
        ...
        <div id="arrows">
            {  !loading && !error && down !== 0 && <div id="left-div">
                    <button className="btn btn-outline-danger" id="left" aria-label="Left Align" onClick={e => changeLeftState(e)}type="button" title="Next" >
